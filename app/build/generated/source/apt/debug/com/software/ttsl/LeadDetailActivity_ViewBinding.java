...
public class LeadDetailActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public LeadDetailActivity_ViewBinding(LeadDetailActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public LeadDetailActivity_ViewBinding(LeadDetailActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    LeadDetailActivity target = this.target;

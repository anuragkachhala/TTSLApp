...
public class SailingScheduleActivity_ViewBinding implements Unbinder {
  private SailingScheduleActivity target;

  @UiThread
  public SailingScheduleActivity_ViewBinding(SailingScheduleActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public SailingScheduleActivity_ViewBinding(SailingScheduleActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    SailingScheduleActivity target = this.target;

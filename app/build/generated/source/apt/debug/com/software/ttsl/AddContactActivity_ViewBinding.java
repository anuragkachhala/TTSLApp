...
public class AddContactActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public AddContactActivity_ViewBinding(AddContactActivity target, View source) {
    this.target = target;
    ...
    target.textViewErrorEmail = Utils.findRequiredViewAsType(source, R.id.tv_error_email, "field 'textViewErrorEmail'", TextView.class);
    target.textViewErrorHomePhone = Utils.findRequiredViewAsType(source, R.id.tv_error_home_phone, "field 'textViewErrorHomePhone'", TextView.class);
    target.textViewErrorOtherPhone = Utils.findRequiredViewAsType(source, R.id.tv_error_other_phone, "field 'textViewErrorOtherPhone'", TextView.class);
    target.textViewErrorFax = Utils.findRequiredViewAsType(source, R.id.tv_error_fax, "field 'textViewErrorFax'", TextView.class);
    target.textViewErrorContactMobile = Utils.findRequiredViewAsType(source, R.id.tv_error_contact_mobile, "field 'textViewErrorContactMobile'", TextView.class);
    target.textViewErrorAssiPhone = Utils.findRequiredViewAsType(source, R.id.tv_error_assi_phone, "field 'textViewErrorAssiPhone'", TextView.class);
    target.textViewErrorSkypeId = Utils.findRequiredViewAsType(source, R.id.tv_error_skype_id, "field 'textViewErrorSkypeId'", TextView.class);
    ...
    target.textViewErrorTitle = Utils.findRequiredViewAsType(source, R.id.tv_error_title, "field 'textViewErrorTitle'", TextView.class);
    ...
    target.textViewErrorDepartment = Utils.findRequiredViewAsType(source, R.id.tv_error_department, "field 'textViewErrorDepartment'", TextView.class);
  }
  ...
  public void unbind() {
    ...
    target.textViewErrorEmail = null;
    target.textViewErrorHomePhone = null;
    target.textViewErrorOtherPhone = null;
    target.textViewErrorFax = null;
    target.textViewErrorContactMobile = null;
    target.textViewErrorAssiPhone = null;
    target.textViewErrorSkypeId = null;
    target.textViewErrorSecondaryMail = null;
    target.textViewErrorTitle = null;
    target.textViewErrorFirstName = null;
    target.textViewErrorDepartment = null;
  }
}

...
public class CallListActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public CallListActivity_ViewBinding(CallListActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public CallListActivity_ViewBinding(CallListActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CallListActivity target = this.target;

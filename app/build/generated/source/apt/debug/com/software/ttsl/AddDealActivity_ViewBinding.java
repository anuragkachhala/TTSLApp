...
public class AddDealActivity_ViewBinding implements Unbinder {
  private AddDealActivity target;

  @UiThread
  public AddDealActivity_ViewBinding(AddDealActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public AddDealActivity_ViewBinding(AddDealActivity target, View source) {
    this.target = target;
    ...
    target.textViewLabelContact = Utils.findRequiredViewAsType(source, R.id.tv_contact_name, "field 'textViewLabelContact'", TextView.class);
    ...
    target.textViewErrorDealName = Utils.findRequiredViewAsType(source, R.id.tv_error_deal_name, "field 'textViewErrorDealName'", TextView.class);
    target.textViewErrorDealClosingDate = Utils.findRequiredViewAsType(source, R.id.tv_error_deal_closing_date, "field 'textViewErrorDealClosingDate'", TextView.class);
    target.textViewErrorDealAccountName = Utils.findRequiredViewAsType(source, R.id.tv_error_deal_account_name, "field 'textViewErrorDealAccountName'", TextView.class);
    target.textViewErrorDealStage = Utils.findRequiredViewAsType(source, R.id.tv_error_deal_stage, "field 'textViewErrorDealStage'", TextView.class);
  }

  @Override
  @CallSuper
  public void unbind() {
    AddDealActivity target = this.target;
    ...
    target.textViewErrorDealName = null;
    target.textViewErrorDealClosingDate = null;
    target.textViewErrorDealAccountName = null;
    target.textViewErrorDealStage = null;
  }
}

...
public class AddTaskActivity_ViewBinding implements Unbinder {
  ...
  public AddTaskActivity_ViewBinding(AddTaskActivity target, View source) {
    ...
    target.textViewLabelTaskSubject = Utils.findRequiredViewAsType(source, R.id.tv_task_subject, "field 'textViewLabelTaskSubject'", TextView.class);
  ...
  public void unbind() {
    ...
    target.toolbar = null;
    target.textViewLabelTaskSubject = null;

...
public class CallDetailActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public CallDetailActivity_ViewBinding(CallDetailActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public CallDetailActivity_ViewBinding(CallDetailActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CallDetailActivity target = this.target;
